      ...
      <div className="flex flex-col md-lg:flex-row border-t border-gray-800">
        <div className="w-full md-lg:w-2/3 flex flex-col border-b md-lg:border-b-0 border-r border-gray-800">
          <div className="h-fit border-b border-gray-800 py-16 px-10">
            ...
            <p className="text-gray-400 text-justify my-5">{description.text}</p>
            <button
          ...
          >
            <p>
              Failure is a step to <span className="text-green-300">success.</span>
            </p>
          </div>
        </div>
        <div className="w-full md-lg:w-1/3 flex flex-col">
          <div className="h-fit w-full flex justify-center border-b border-gray-800 py-16 px-12">
            <img
              src={PersonalPhoto}
              className="w-fit object-cover h-64 rounded overflow-hidden"
              alt="Personal Photo"
            />
          </div>
          <div className="w-full h-fit p-5 flex justify-center gap-10 md-lg:justify-between items-center bg-violet-500 hover:tracking-wide hover:bg-violet-600 transition-all cursor-pointer tracking-normal duration-200">
            <a href="#Projects" className="text-md md-lg:text-sm border-gray-400">
